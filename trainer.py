...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    batch_time, losses, top1, top5, data_time, progress = get_epoch_meters(train_loader)
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        per_batch(model, criterion, images, target, losses, top1, top5, args.gpu, optimizer=optimizer)
...
def validate(val_loader, model, criterion, args):
    ...
    """
    batch_time, losses, top1, top5, data_time, progress = get_epoch_meters(val_loader)
    ...
    with torch.no_grad():
        ...
        for i, (images, target) in enumerate(val_loader):
            data_time.update(time.time() - end)
            per_batch(model, criterion, images, target, losses, top1, top5, args.gpu)
...
def get_epoch_meters(data_loader):
...
def per_batch(model, criterion, images, target, losses_meter, top1_meter, top5_meter, gpu=None, optimizer=None):
    """
